package com.redis.redisson.handler;
...
import com.redis.AquariusConstant;
import com.redis.AquariusContent;
...
public class RedissonHandler {
    ...
    public static RedissonClient createDefaultRedisson() {
        try {
            Config config = RedissonHandler.createYamlConfig(CONFIG_FILE);
